...
function ParentMessagesPage() {
                    ...
                    <div className='chatroomBox row' onClick={openChatRoom}>
                        <div className='chatroomInfo row'>
                            ...
                            <div className='column senderInfo'>
                                ...
                                <span className='chatLastDate'>{date}</span>
    ...
    window.addEventListener('popstate', (event) => {
        // if (){
            ...
            console.log(":: ",event.overlayOpen)
            console.log(": :",window.location.pathname.includes("/messages"))
            console.log("width:",window.innerWidth <= RedesignOnWidth)
            console.log("width:", localStorage.getItem("ActiveChat")!= null)
            console.log("Chekc: ",event.state && event.state.overlayOpen && window.location.pathname.includes("/messages") && window.innerWidth <= RedesignOnWidth && localStorage.getItem("ActiveChat")!= null)
            // if (!event.state  && window.location.pathname.includes("/messages") && window.innerWidth <= RedesignOnWidth && localStorage.getItem("ActiveChat")!= null) {
            //     HideChatRoom();
            //     // openChatRoom();
            // }else{
    ...
    function DeleteAmessage(event){
        ...
        event.currentTarget.parentElement.querySelector(".open").classList.remove("open")
